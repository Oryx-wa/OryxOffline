(function () {
    angular.module('app').controller('app.views.arInvoices.index', [
        '$scope', 'abp.services.app.salesInvoice',
        function ($scope, arService) {
            ...
            vm.loadSalesInvoices = function () {
                abp.ui.setBusy(null,
                    arService.getSalesInvoicesPaged({}).success(function (data) {
                        vm.salesInvoices = data.items;
                    })
                );
            }

            vm.loadSalesInvoices();
